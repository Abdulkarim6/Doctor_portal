...
const AppointmentOptions = ({ selectedDate }) => {
    ...
    // useEffect(() => {
    //     fetch("https://hospital-server-code.vercel.app/appointmentOptions")
    //         .then(res => res.json())
    ...
    const { data: availableAppointmentOptions = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`https://hospital-server-code.vercel.app/appointmentOptions?date=${date}`)
